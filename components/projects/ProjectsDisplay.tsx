...
const ProjectsDisplay = ({ projects }: { projects: MergedProject[] }) => {
  ...
  return (
    <>
      ...
      <motion.section
        ...
        viewport={{ once: false }}
        className='mt-4 flex min-h-screen flex-col items-center md:mt-20'
      >
        <motion.div
          ...
          {projects.map((project, index) => (
            <div key={project.id} className='flex flex-col items-center'>
              ...
              <div className='flex flex-row items-center gap-3 text-center'>
                ...
                <h3 className='custom-subheader custom-transition-class font-semibold md:text-2xl'>
      ...
      {projects.map((project, projectIndex) => (
        <div key={project.id}>
          ...
          {projectIndex < 4 && (
            <div className='mt-2 flex w-full flex-row items-center justify-center gap-x-4 md:mt-0'>
              <div className='h-2 w-2 rounded-full bg-blue-400 md:h-3 md:w-3'></div>
              <div className='h-2 w-2 rounded-full bg-blue-400 md:h-3 md:w-3'></div>
              <div className='h-2 w-2 rounded-full bg-blue-400 md:h-3 md:w-3'></div>
            </div>
          )}
