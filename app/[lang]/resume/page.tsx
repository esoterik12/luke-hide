...
const ResumePage = ({ params: { lang } }: { params: { lang: Locale } }) => {
  const languagesArray = [
    ...
    },
    {
      ...
      language: 'Chinese',
      level: 'B2',
      flagImage: '/images/flags/china.svg',
      color: 'border-blue-600',
      textColor: 'text-blue-600 dark:text-blue-500'
    },
    {
      ...
      <section className='flex flex-row'>
        ...
        <div className='flex flex-col'>
          ...
          <p className='mt-4'>
            ...
            Learning Management System Administrator, recruiter, and team leader
        ...
        <div className='m-2 flex flex-row'>
          ...
          <div className='ml-2 flex w-4/5 flex-col justify-start'>
            ...
            <ul className='list ml-4 list-disc'>
              ...
              <li>
                Provided daily technical support and training to all employees,
          ...
          <div className='ml-2 flex w-4/5 flex-col justify-start'>
            ...
            <ul className='list ml-4 list-disc'>
              ...
              <li>
                ...
                learning environment across the branch and ensuring all students
                met their learning objectives.
              </li>
              <li>
